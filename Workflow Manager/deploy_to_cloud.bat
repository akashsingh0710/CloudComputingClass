::pscp requires putty
pscp -pwfile pwfile.txt .\workflow_manager.py .\workflow_router.py .\network_config.json generic@csa-6343-93.utdallas.edu:/home/generic/Desktop/
pscp -pwfile pwfile.txt .\workflow_router.py generic@csa-6343-103.utdallas.edu:/home/generic/Desktop/
